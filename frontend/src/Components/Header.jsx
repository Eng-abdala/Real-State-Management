      ...
      <div className="flex justify-between sm:px-10 px-5 bg-[#003049] font-semibold text-white py-6 items-center">
        ...
        <div className="sm:flex items-center hidden">
          <Link to="/ComplaintForm">
            <button className=" text-black  bg-[#a8dadc]  text-[20px] hover:border-2 hover:border-[#a8dadc] hover:bg-white px-4 py-2 rounded-full transition duration-300 ease-in-out shadow-md">
              Send Complaint
            </button>
          </Link>
        </div>
