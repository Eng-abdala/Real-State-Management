...
export default function Header() {
  ...
  return (
    <div className="font-[Roboto]">
      {/* Header */}
      <div
        className="flex justify-between px-20 bg-[#003049] text-white py-6 items-center"
      >
      ...
      {/* Second Section */}
      <div
        className="bg-[url('src/images/dd.jpg')] relative h-[600px] bg-cover bg-center items-center text-center pt-52"
      >
        <div className="absolute inset-0 bg-[#036194] opacity-10 "></div>
      ...
      <motion.div
        ...
        className="flex justify-center gap-10 relative -top-5"
      >
